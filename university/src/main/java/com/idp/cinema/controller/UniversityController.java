...
public class UniversityController {
    ...
    public UniversityController(UniversityService universityService, JwtTokenUtil jwtTokenUtil, CinemaProperties cinemaProperties, ObjectMapper objectMapper, RabbitSender rabbitSender) {
...
//        log.info(String.format("Sending create reservation request to queue: %s", application));
